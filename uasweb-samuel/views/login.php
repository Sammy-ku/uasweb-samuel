...
<form class="min-w-[350px] w-[500px] max-w-[500px] border-2 border-gray-900 rounded-2xl py-8 px-5" action="/login" method="post">
  <h1 class="text-center text-2xl font-extrabold text-gray-900">Login</h1>
  <div class="mb-5">
  ...
  <div class="text-right mb-5">
    <p>Silakan <a href="/register" class="italic underline text-indigo-500">Daftar</a>, Jika tidak memiliki Akun!</p>
  </div>
